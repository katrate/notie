...
const DOWNLOADS = {
  windows: {
    ...
    files: [
      ...
      { name: "Portable (.zip)", url: `https://github.com/katrate/notie/releases/download/v${version}/Notie-${version}-win-x64.zip` },
    ],
  },
  macos: {
    label: "macOS",
    ...
    <section className="downloads" id="downloads">
      <div className="container">
        <div className="section-header">
          ...
          <p>Available for Windows and macOS. Get the latest version and start organizing your knowledge today.</p>
        </div>
        ...
        <p className="downloads-footer">
          ...
          <a href="https://github.com/katrate/notie/releases" target="_blank" rel="noopener noreferrer">GitHub Releases</a>.
